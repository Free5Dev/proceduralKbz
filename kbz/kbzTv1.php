				...
				<div class="row">
					<div class="col-md-9  col-sm-12 kbzTvGauche">
						<div class="kbzTvGaucheContenu">
							...
							<div id="commentaire">
								...
								<div class="fb-comments" data-href="http://localhost/phpProcedural/kbz/blogCommentaire.php?ref=<?php echo $donneesBlog['id']; ?>" data-width="700" data-numposts="5"></div>
							</div>
					...
					<div class="col-md-3 col-sm-12 kbzTvDroite" style="padding: 0px;">
						<div class="kbzTvDroiteContenu" >
							...
							<p><a href="index.php"><iframe width="250" height="170" src="<?php echo $donneesZic['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></a></p>
