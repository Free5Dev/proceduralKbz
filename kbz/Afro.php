<?php 
	...
	// requete rap afro
	$reqMusiqueAfro=$bdd->query("SELECT z.id,m.nom,z.nomArtiste,z.titre,c.categorie,z.url,z.origine,date_format(datePub, '%d/%m/%Y à %Hh%imin%ss') as datePub FROM musique as z,membre as m,musiquecategorie as c WHERE z.idMembre=m.id and z.idMusiqueCategorie=c.id and z.idMusiqueCategorie=3 ORDER BY ID DESC LIMIT 5");
	// requete rap usa
	...
	<body>
		...
		<section id="kbzTv">
			<div class="container-fluid kbzTvContainer">
				<h1><span class="text-danger">K.B.Z</span> Afro Musique rétrouver tous les dernièrs clip des stars Africains...Krah Krah  <img src="images/laughing.png" alt=""> <img src="images/laughing.png" alt=""> <img src="images/laughing.png" alt=""></h1>
				<div class="row">
					<div class="col-md-8  col-sm-12 kbzTvGauche">
						<?php while($donneesMusiqueAfro=$reqMusiqueAfro->fetch()) { ?>
						<div class="kbzTvGaucheContenu">
							<h2><span class="text-danger">Artiste(s):</span> <?php echo $donneesMusiqueAfro['nomArtiste']; ?> <span class="text-danger">Titre:</span> <?php echo $donneesMusiqueAfro['titre']; ?></h2>
							...
							<p><iframe class="img-fluid border border-dark iframe"  src="<?php echo $donneesMusiqueAfro['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></p>
							<p><strong><a href="afroCommentaire.php?ref=<?php echo $donneesMusiqueAfro['id']; ?>">Commentaires</a></strong></p>
						...
						<?php } $reqMusiqueAfro->closeCursor(); ?>
					</div>

					<div class="col-md-4 col-sm-12 kbzTvDroite" style="padding: 0px;">
						<div class="kbzTvDroiteContenu" >
							<!--  -->
							<h3><img src="images/blog-symbol.png"> top Rap Usa</h3>
							<?php while($donneesMusiqueUsa=$reqMusiqueUsa->fetch()) { ?>
							<p><a href="index.php"><small style=""><?php echo $donneesMusiqueUsa['titre']; ?></small></a></p>
							<p><a href="index.php"><iframe width="450" height="190" src="<?php echo $donneesMusiqueUsa['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></a></p>
							...
							<!--  -->
							<h3><img src="images/blog-symbol.png"> top rap fr</h3>
							<?php while($donneesFr=$reqMusiqueFr->fetch()) { ?>
							<p><a href="index.php"><small style=""><?php echo $donneesFr['titre']; ?></small></a></p>
							<p><a href="index.php"><iframe width="450" height="190" src="<?php echo $donneesFr['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></a></p>
							<p><mark style="background-color: green;"> <a href="index.php" style="color: white;">Voir détails</a></mark></p><hr class="separator">
