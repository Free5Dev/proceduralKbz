				...
				<div class="row">
					<div class="col-md-8  col-sm-12 kbzTvGauche">
						...
						<div class="kbzTvGaucheContenu">
							...
							<p><iframe class="img-fluid border border-dark iframe"  src="<?php echo $donneesBlog['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></p>
							<p><strong><a href="blogCommentaire.php?ref=<?php echo $donneesBlog['id']; ?>">Voir plus</a></strong></p>
