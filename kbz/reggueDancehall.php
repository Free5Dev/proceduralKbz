<?php 
	...
	// requete reggue
	$reqMusiqueReggue=$bdd->query("SELECT z.id,m.nom,z.nomArtiste,z.titre,c.categorie,z.url,z.origine,date_format(datePub, '%d/%m/%Y à %Hh%imin%ss') as datePub FROM musique as z,membre as m,musiquecategorie as c WHERE z.idMembre=m.id and z.idMusiqueCategorie=c.id and z.idMusiqueCategorie=4 ORDER BY ID DESC LIMIT 5");
	// requete rap afro
	...
	<body>
		...
		<section id="kbzTv">
			<div class="container-fluid kbzTvContainer">
				<h1><span class="text-danger">K.B.Z</span> reggue - dancehall rétrouver tous les dernièrs clip des stars jamaïcaines...Krah Krah  <img src="images/laughing.png" alt=""> <img src="images/laughing.png" alt=""> <img src="images/laughing.png" alt=""></h1>
				<div class="row">
					<div class="col-md-8  col-sm-12 kbzTvGauche">
						...
						<div class="kbzTvGaucheContenu">
							<h2><span class="text-danger">Artiste(s):</span> <?php echo $donneesMusiqueReggue['nomArtiste']; ?> <span class="text-danger">Titre:</span> <?php echo $donneesMusiqueReggue['titre']; ?></h2>
							...
							<p><iframe class="img-fluid border border-dark iframe"  src="<?php echo $donneesMusiqueReggue['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></p>
							<p><strong><a href="reggueDancehallCommentaire.php?ref=<?php echo $donneesMusiqueReggue['id']; ?>">Commentaires</a></strong></p>
						...
						<?php } $reqMusiqueReggue->closeCursor(); ?>
					</div>
