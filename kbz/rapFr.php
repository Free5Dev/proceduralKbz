<?php 
	...
	// requete rap fr
	$reqMusiqueFr=$bdd->query("SELECT z.id,m.nom,z.nomArtiste,z.titre,c.categorie,z.url,z.origine,date_format(datePub, '%d/%m/%Y à %Hh%imin%ss') as datePub FROM musique as z,membre as m,musiquecategorie as c WHERE z.idMembre=m.id and z.idMusiqueCategorie=c.id and z.idMusiqueCategorie=2 ORDER BY ID DESC LIMIT 5");
	// requete rap afro
	...
	<body>
		...
		<section id="kbzTv">
			<div class="container-fluid kbzTvContainer">
				<h1><span class="text-danger">K.B.Z</span> Rap Fr rétrouver tous les dernièrs clip des stars Français...Krah Krah  <img src="images/laughing.png" alt=""> <img src="images/laughing.png" alt=""> <img src="images/laughing.png" alt=""></h1>
				<div class="row">
					<div class="col-md-8  col-sm-12 kbzTvGauche">
						<?php while($donneesFr=$reqMusiqueFr->fetch()) { ?>
						<div class="kbzTvGaucheContenu">
							<h2><span class="text-danger">Artiste(s):</span> <?php echo $donneesFr['nomArtiste']; ?> <span class="text-danger">Titre:</span> <?php echo $donneesFr['titre']; ?></h2>
							<p class="petit"><strong>Rédacteur: </strong><img src="images/man-user.png" alt=""><small><?php echo $donneesFr['nom']; ?></small> <strong>Date: </strong> <img src="images/calendar-with-a-clock-time-tools.png" alt=""> <small> le <?php echo $donneesFr['datePub']; ?></small></p>
							<p><iframe class="img-fluid border border-dark iframe"  src="<?php echo $donneesFr['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></p>
							<p><strong><a href="rapFrCommentaire.php?ref=<?php echo $donneesFr['id']; ?>">Commentaires</a></strong></p>
							...
							<div id="btnSociaux">
								<div class="btnSociaux">
									...
									<div class="fb-share-button btn btn-fluid btn-outline-info" data-href="http://localhost/phpProcedural/kbz/rapFr.php" data-layout="button_count" data-size="large" data-mobile-iframe="true"><a target="_blank" href="https://www.facebook.com/sharer/sharer.php?u=http%3A%2F%2Flocalhost%2FphpProcedural%2Fkbz%2FkbzTv.php&amp;src=sdkpreparse" class="fb-xfbml-parse-ignore">Partager</a></div>
								</div>
								<div class="btnSociaux">
					...
					<div class="col-md-4 col-sm-12 kbzTvDroite" style="padding: 0px;">
						<div class="kbzTvDroiteContenu" >
							...
							<p><a href="index.php"><small style=""><?php echo $donneesMusiqueAfro['titre']; ?></small></a></p>
							<p><a href="index.php"><iframe width="450" height="190" src="<?php echo $donneesMusiqueAfro['url']; ?>" frameborder="0" allow="autoplay; encrypted-media" allowfullscreen></iframe></a></p>
							...
							<p><a href="index.php"><small style=""><?php echo $donneesMusiqueReggue['titre']; ?></small></a></p>
